...
import { LuzAmbiente } from './light/LuzAmbiente';
...
const gui = new GUI({
  ...
  closeFolders: true  
    ...
    const lightFolder = gui.addFolder('Ambient Light');
		lightFolder.addColor( new ColorGUIHelper( LuzAmbiente, 'color' ), 'value' ).name( 'color' );
		lightFolder.add( LuzAmbiente, 'intensity', -1, 100 );
